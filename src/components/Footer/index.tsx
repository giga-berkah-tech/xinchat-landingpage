        ...
        <div className="container">
          ...
          <div className="py-8">
            <p className="text-body-color text-center text-base dark:text-white">
              © {new Date().getFullYear()} Designed and developed by XinLeo
              Team {pkg.version}
            </p>
          </div>
        </div>
          ...
          >
            ...
            <defs>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#31a354" stopOpacity="0.62" />
              ...
              >
                ...
                <stop offset="1" stopColor="#31a354" stopOpacity="0.51" />
              </linearGradient>
              <linearGradient
