...
import Phone1 from '@/images/photo_2024-12-14_13-04-57.jpg'
            ...
            <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
              <div className="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
                <h1 className="text-4xl font-medium tracking-tight text-gray-900">
                  {t('Connect important information.')}
                </h1>
                <p className="mt-6 text-lg text-gray-600">
                  {t(
                    'Our chat app provides seamless connections and efficient communication to help you easily share important information and increase productivity. Every communication was clear and valuable, and he experienced a new realm of fluid communication.'
                  )}
                </p>
